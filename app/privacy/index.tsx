...
const copy = {
  en: {
    ...
    sections: [
      ...
      {
        heading: 'Contact',
        body: 'If you have any questions about this privacy policy or your data, please contact us at: peiyanlu@gmail.com',
      },
    ],
  },
  zh: {
    ...
    sections: [
      ...
      {
        heading: '联系方式',
        body: '如果您对本隐私政策或您的数据有任何疑问，请联系我们：peiyanlu@gmail.com',
      },
    ],
  },
} as const;
